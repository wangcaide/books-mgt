...
CREATE UNIQUE INDEX ID_TYPE_NUMBER_UNIQUE ON PERSON(ID_TYPE,ID_NUMBER);
...
CREATE TABLE BOOK(
    ...
    `BOOK_CATEGORY_ID` VARCHAR(255) NOT NULL   COMMENT '分类ID' ,
...
CREATE TABLE BOOK_CATEGORY(
    ...
    `CATEGORY_DESCRIPTION` VARCHAR(255)    COMMENT '分类描述' ,
    `CREATED_BY` VARCHAR(32)    COMMENT '创建人' ,
    `CREATED_TIME` DATETIME    COMMENT '创建时间' ,
    `UPDATED_BY` VARCHAR(32)    COMMENT '更新人' ,
    `UPDATED_TIME` DATETIME    COMMENT '更新时间' ,
...
CREATE TABLE BORROW_LOG(
    ...
    `BOOK_CATEGORY_ID` VARCHAR(255)    COMMENT '图书分类' ,
...
CREATE TABLE OPERATION_LOG(
    ...
    `SYSTEM` VARCHAR(255)    COMMENT '所在系统' ,
    `CREATED_BY` VARCHAR(32)    COMMENT '创建人(操作人)' ,
    `CREATED_TIME` DATETIME    COMMENT '创建时间' ,
    `UPDATED_BY` VARCHAR(32)    COMMENT '更新人' ,
    `UPDATED_TIME` DATETIME    COMMENT '更新时间' ,
